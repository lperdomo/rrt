...
\begin{figure}[ht]
	\centering	
	\subfigure[ref1][Technical Report 98-11]{\includegraphics[scale=0.20]{artigo}}
	\subfigure[ref2][S. M. LaValle]{\includegraphics[scale=0.25, width=70]{lavalle}}
	\caption{Originally published on Oct. 1998 by S. M. LaValle.}
\end{figure}
}
...
\frame{\frametitle{Properties}
	...
	\begin{itemize}
		\item Usually insufficient alone; randomness leads to zigzags;				
	\end{itemize}
